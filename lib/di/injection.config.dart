...
import '../src/application/auth/auth_bloc.dart' as _i17;
...
import '../src/infrastructure/core/firebase_injectable_module.dart' as _i19;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i17.AuthBloc>(
      () => _i17.AuthBloc(get<_i13.IAuthFacade>(), get<_i7.IMailFacade>()));
  gh.factory<_i18.ForgotPasswordBloc>(
      () => _i18.ForgotPasswordBloc(get<_i13.IAuthFacade>()));
  return get;
}
