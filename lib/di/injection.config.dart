...
import '../application/core/settings/settings_bloc.dart' as _i22;
...
import '../infrastructure/settings/settings_facade.dart' as _i21;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i13.ProfileBloc>(() => _i13.ProfileBloc(get<_i7.IAuthFacade>()));
  ...
  await gh.lazySingletonAsync<_i15.SharedPreferences>(
      ...
      preResolve: true);
  gh.factory<_i16.SignInBloc>(() => _i16.SignInBloc(get<_i7.IAuthFacade>()));
  gh.factory<_i17.SignUpBloc>(() => _i17.SignUpBloc(get<_i7.IAuthFacade>()));
  gh.factory<_i18.AuthBloc>(() => _i18.AuthBloc(get<_i7.IAuthFacade>(),
      get<_i9.IMailFacade>(), get<_i15.SharedPreferences>()));
  ...
  gh.factory<_i22.SettingsBloc>(
      () => _i22.SettingsBloc(get<_i20.ISettingsFacade>()));
  return get;
}
