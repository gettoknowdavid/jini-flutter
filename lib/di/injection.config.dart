...
import '../application/auth/forgot_password/forgot_password_bloc.dart' as _i22;
...
import '../application/core/settings/settings_bloc.dart' as _i30;
import '../application/create_request/create_request_bloc.dart' as _i20;
import '../application/profile/profile_bloc.dart' as _i29;
import '../domain/auth/i_auth_facade.dart' as _i8;
import '../domain/location/i_location_facade.dart' as _i23;
import '../domain/mail/i_mail_facade.dart' as _i10;
import '../domain/media/i_media_facade.dart' as _i25;
import '../domain/request/i_request_facade.dart' as _i21;
import '../domain/settings/i_settings_facade.dart' as _i27;
...
import '../infrastructure/location/location_facade.dart' as _i24;
import '../infrastructure/mail/open_mail_app_facade.dart' as _i11;
import '../infrastructure/media/media_facade.dart' as _i26;
import '../infrastructure/settings/settings_facade.dart' as _i28;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i20.CreateRequestBloc>(() => _i20.CreateRequestBloc(
      get<_i8.IAuthFacade>(), get<_i21.IRequestFacade>()));
  gh.factory<_i22.ForgotPasswordBloc>(
      () => _i22.ForgotPasswordBloc(get<_i8.IAuthFacade>()));
  gh.lazySingleton<_i23.ILocationFacade>(
      () => _i24.LocationFacade(get<_i14.Location>()));
  gh.lazySingleton<_i25.IMediaFacade>(() => _i26.MediaFacade(
      get<_i4.FirebaseAuth>(),
      get<_i6.FirebaseStorage>(),
      get<_i12.ImagePicker>()));
  gh.lazySingleton<_i27.ISettingsFacade>(() => _i28.SettingsFacade(
      get<_i16.SharedPreferences>(), get<_i15.SettingsMapper>()));
  gh.factory<_i29.ProfileBloc>(() => _i29.ProfileBloc(get<_i8.IAuthFacade>(),
      get<_i25.IMediaFacade>(), get<_i23.ILocationFacade>()));
  gh.factory<_i30.SettingsBloc>(
      () => _i30.SettingsBloc(get<_i27.ISettingsFacade>()));
  return get;
}
